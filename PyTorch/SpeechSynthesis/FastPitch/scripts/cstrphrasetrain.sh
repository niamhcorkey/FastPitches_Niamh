...
: ${BATCH_SIZE:=8}
: ${GRAD_ACCUMULATION:=1}
: ${OUTPUT_DIR:=${DS_HOME}/sgile/trained_models/newsymbols}
: ${DATASET_PATH:=${DS_HOME}/sgile/downsampled}
: ${TRAIN_FILELIST:=${DS_HOME}/sgile/downsampled/train_phones.txt}
: ${VAL_FILELIST:=${DS_HOME}/sgile/downsampled/val_phones.txt}
: ${AMP:=false}
: ${SEED:=""}
