...
export DATASET_PATH=$DS_HOME/LJ_Chopped/wavs
...
export TRAIN_FILELIST=$DS_HOME/LJ_Chopped/abs_chopped_train.txt
export VAL_FILELIST=$DS_HOME/LJ_Chopped/abs_chopped_val.txt
