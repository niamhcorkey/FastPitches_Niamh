...
export OUTPUT_DIR=$DS_HOME/trained_models/$1
...
export TRAIN_FILELIST=$FP/filelists/trainsmallbatch.txt
export VAL_FILELIST=$FP/filelists/valsmallbatch.txt
